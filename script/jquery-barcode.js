...
(function(b) {
	var a = {
		...
		digitToCssRenderer: function(q, d, m, e, p, g) {
			...
			var c = m[0].length;
			var j = "";
			var o = '<div   class="txtclass" style="float: left; font-size: 0px; background-color: ' + d.bgColor + "; height: " + g + 'px; width: &Wpx"></div>';
			var l = '<div   class="txtclass" style="float: left; font-size: 0px; width:0; border-left: &Wpx solid ' + d.color + "; height: " + g + 'px;"></div>';
			var f, h;
			for (var k = 0; k < r; k++) {
				f = 0;
				h = m[k][0];
